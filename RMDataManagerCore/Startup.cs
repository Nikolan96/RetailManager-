...
using RMDataManagerCore.Data;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Swashbuckle.AspNetCore.Swagger;
using RMDataManagerCore.Library.Interfaces;
using RMDataManagerCore.Library.DataAccess;
using RMDataManagerCore.Library.Internal.DataAccess;
using RMDataManagerCore.Library;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IBillData, BillData>()
                    ...
                    .AddScoped<IOrderData, OrderData>()
                    .AddScoped<IOrderItemData, OrderItemData>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            ConnectionString = Configuration["ConnectionStrings:RMData"];
